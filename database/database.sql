...
insert into users values(1,"Amine","Chafii","Chafii","123");
insert into users values(2,"amine","","admin@admin.com","password");
...
Insert into ETUDIANT (CODE_ETUDIANT,NOM,PRENOM,NOM_AR,PRENOM_AR,DIPLOME,ID_GROUPE) values ('K121212','Chafii','Amine','test','test','Licence Pro',1);
Insert into ETUDIANT (CODE_ETUDIANT,NOM,PRENOM,NOM_AR,PRENOM_AR,DIPLOME,ID_GROUPE) values ('K121212','Chafii','Amine','AZAZ','CACC','LIcence Pro',1);
...
Insert into ETUDIANT (CODE_ETUDIANT,NOM,PRENOM,NOM_AR,PRENOM_AR,DIPLOME,ID_GROUPE) values ('K13944','Molta','Aymane','test','test','Licence Pro',1);
...
Insert into PROFESSEUR (NOM,PRENOM,CODEPPR,TYPE) values ('Hanine','Samir','K2201','Permanant');
Insert into PROFESSEUR (NOM,PRENOM,CODEPPR,TYPE) values ('Baidada','Chafik','K2202','Permanant');
Insert into PROFESSEUR (NOM,PRENOM,CODEPPR,TYPE) values ('Dahbi','Danil','K2203','Permanant');
